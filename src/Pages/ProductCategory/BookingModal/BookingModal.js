        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    <label htmlFor="order-modal" className="btn btn-sm btn-circle text-white absolute right-2 top-2">✕</label>
                    ...
                    <form onSubmit={handleOrder} className='mt-6 grid gap-2 grid-cols-1'>
                        ...
                        <input className='btn text-white w-full mt-4' type="submit" value="Submit" />
                    </form>
                </div>
            </div>
        </>
